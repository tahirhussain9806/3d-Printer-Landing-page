...
const Header = () => {
  ...
  return (
    <header
      className={`${
        isActive ? 'lg:top-0 bg-white' : 'lg:top-[60px]'
      } py-1 lg:py-1 fixed w-full transition-all z-10`}
    >
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <a href="#_" class="rounded-md px-2  py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-blue-600 text-blue-600 text-white">
...
<span class="relative text-blue-600 transition duration-300 group-hover:text-white ease">Contact us</span>
</a>
